...
#ifndef PROTOBUF_INCLUDED_onnx
#define PROTOBUF_INCLUDED_onnx
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_onnx 
...
class AttributeProto : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:onnx.AttributeProto) */ {
 ...
 private:
  ...
  friend struct ::protobuf_onnx::TableStruct;
};
// -------------------------------------------------------------------
