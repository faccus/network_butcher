...
namespace network_butcher::kfinder
{
  ...
  {
  protected:
    using KFinder<Graph_type>::graph;
    ...
    extract_first_sidetrack_edge(const node_id_type &j, const H_g_collection &h_g) const;
  ...
  public:
    ...
    explicit basic_KEppstein(Graph_type const &g)
      : KFinder<Graph_type>(g){};

    explicit basic_KEppstein(Weighted_Graph<Graph_type> const &g)
      : KFinder<Graph_type>(g){};
  ...
  basic_KEppstein<Graph_type>::extract_first_sidetrack_edge(const node_id_type &j, const H_g_collection &h_g) const
  {
  ...
  template <class Graph_type>
  h_edge_edges_type
  basic_KEppstein<Graph_type>::get_internal_edges(const H_out_pointer &h_out) const
  {
  ...
  template <class Graph_type>
  edge_sequence
  basic_KEppstein<Graph_type>::get_alternatives(const H_g          &h_g,
                                                edge_edges_type    &h_g_edge_edges,
                                                edge_edges_type    &h_out_edge_edges,
