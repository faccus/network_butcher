...
namespace network_butcher
{
  namespace io
  {
    /// @brief IO_Manager manages the input/output interactions of the program with the local disk. The methods of this namespace allow the user to import an .onnx file, import the execution time of each network layer from a .csv file and to export a partitioned network to multiple .onnx files
    namespace IO_Manager
    {
      namespace utilities
      {

        /// @brief Based on the original graph and the partitions device/nodes, it will produce the "butchered" models and export them to the specified path (directory / name)
      ...
      /// @brief It will return the parameters read from the given file
      ...
      /// @brief It will import a neural network as a graph from a given .onnx file
      /// @param path The file path of the .onnx file
      /// @param add_input_padding  If true, a "fake" nodes will be added at the beginning of the network, so that the resulting graph has a single input
      /// @param add_output_padding If true, a "fake" nodes will be added at the at the end of the network, so that the resulting graph has a single output
      ...
      /// @return A tuple made by the graph, the onnx::ModelProto for the .onnx file and a map associating every node in the graph to every node in the model (through their ids)
      ...
      /// @brief It will export a given onnx::ModelProto to a file
      ...
      /// @brief It will import the collection of weights for the given graph
      ...
      /// @brief It will export the network partitions to multiple .onnx files
      /// @param params The parameters
      ...
      /// @brief It will try to construct a onnx::ModelProto from the given partition.
      ...
      /// @brief It will return the different Parameters read from the given .yaml files for the required models
